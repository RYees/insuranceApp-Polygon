...
export default function Sidebar() {
	return (
	   <div className="py-2 px-2 bg-green-200 mx-1 box-shadow w-64">
        ...
        <nav className=''>
            <ul className='flex-col mt-3 text-xl font-serif'>
                ...
                <li className="flex mb-2 cursor-pointer hover:brightness-110">
                   <AiOutlineFolderView className="mt-1"/> <Link className='ml-2 hover:text-black text-gray-800' to="/viewvehicles">My Claims</Link>
                </li>
                ...
                <li className="flex mb-2 cursor-pointer hover:brightness-110">
                    <GiNewspaper className="mt-1"/> <Link className='ml-2 hover:text-black text-gray-800' to="/insurancepolicyregister">Policy Registration</Link>
                </li>

                <li className="flex mb-2 cursor-pointer hover:brightness-110">
                   <AiOutlineFolderView className="mt-1"/> <Link className='ml-2 hover:text-black text-gray-800' to="/allclaims">All Policies</Link>
                </li>
